document.addEventListener("DOMContentLoaded", function(){
	...
	on(one("#widget-body-toggler"), "click", function(e){
		...
		wBody.classList.toggle("full");
		if(wBody.classList.contains("full")) {this.classList.add("purple");this.innerHTML = "&nbsp;&laquo;&nbsp;";}
	...
	on(one("#pre-filters-toggler"), "click", function(e){
		...
		if(prefilters.classList.contains("toggled")) {this.innerHTML = "&nbsp;&darr;&nbsp;";}
		else {this.innerHTML = "&nbsp;&uarr;&nbsp;";}
	});
